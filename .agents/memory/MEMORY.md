...
- [Mermaid sequence E2E styling](mermaid-sequence-e2e-styling.md) — messageLine0 keeps inline stroke="none"; assert themed CSS separately from Playwright visibility
