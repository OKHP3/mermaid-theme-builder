...
---
# Skill Creator
Define scope and success criteria before editing. Use representative, boundary, and adversarial prompts, compare with-skill and without-skill behavior when execution is available, and record evidence rather than impressions. Do not fabricate live results. Validate package portability, tests, references, and security boundaries before recommending release.
