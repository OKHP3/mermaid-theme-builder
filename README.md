...
- **31 diagram families** cataloged (21 supported, 10 tracked as capability gaps) with family-specific theming overlays
- **3 rendering looks** — Classic, Neo, Hand-Drawn — sourced from Mermaid v11.16.0's look API
- **8 renderer profiles** — mermaid.live, GitHub, GitLab, Notion, Obsidian, Confluence, CLI, and one more — with parity matrix and contextual look warnings (see the Reference tab; the table below is missing the 8th entry)
...
## Supported Diagram Families (31 cataloged)
...
> **Known drift (2026-08-04):** the auto-generated catalog below currently lists 8 skills. The live app's Reference tab lists 9, including `okhp3-mermaid-governance` (Governance, v1.1.0), whose folder already exists in this repo but isn't picked up by the generator. Re-run `scripts/gen-skills-readme.py` (or fix why it excludes that skill) rather than hand-editing the table below.

<!-- SKILLS_CATALOG_START -->
<!-- ⚠️ DO NOT EDIT THIS SECTION MANUALLY — regenerated by scripts/gen-skills-readme.py -->
<!-- Generated: 2026-08-01 04:53 UTC | Skills: 8 | Categories: 1 | Mode: library | Surface: distribution -->

*Catalog last updated: **August 1, 2026 at 04:53 UTC** &nbsp;·&nbsp; **8** skills across **1** categories*
...
*(Missing from the table above as of 2026-08-04: `okhp3-mermaid-governance`, v1.1.0 — see the note before this section.)*
