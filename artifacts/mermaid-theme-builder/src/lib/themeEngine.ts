...
function buildMetaComments(palette: Palette, themeName: string): string {
  ...
  lines.push(`%% Personal project by Jamie Hill / OverKill Hill P³ — not associated with any employer or employer-owned brand`);
...
export function generateMarkdownExport(themedCode: string, palette: Palette, options: ExportOptions): string {
  ...
  const disclaimerNote = `\n> _Personal project by [Jamie Hill](https://overkillhill.com) / OverKill Hill P³. Not associated with any employer or employer-owned brand. Not affiliated with Mermaid, Mermaid Chart, or Mermaid.ai. All transformations are local — your diagram code never leaves the browser._`;
...
%% Theme ID: ${palette.id}
%% Tool: ${TOOL_URL}
%% Personal project by Jamie Hill / OverKill Hill P³ — not associated with any employer or employer-owned brand
...
*Personal project by Jamie Hill / [OverKill Hill P³](https://overkillhill.com). Not associated with any employer or employer-owned brand. Not affiliated with Mermaid, Mermaid Chart, or Mermaid.ai.*
`;
}
