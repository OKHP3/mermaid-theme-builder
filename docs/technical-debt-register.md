...
| TD-06 | Code quality | `ApplyTab.tsx` is ~1306 lines (grew from ~1017 during v0.5.x sprint) | Well past decomposition threshold; hard to navigate and test; high conflict surface for agent tasks | Medium | Extract: export toolbar, warning section, preview panel, detect header into sub-components; target under 500 lines | Medium | Open |
