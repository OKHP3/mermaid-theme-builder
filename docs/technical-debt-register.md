...
|---|---|---|---|---|---|---|---|
| TD-01 | Testing | ~~No Playwright / E2E tests — 659 Vitest unit and component tests exist but the full paste–detect–export pipeline had no end-to-end coverage~~ | ~~Renderer-level regressions and interaction bugs are not caught in CI; complex multi-step flows require manual verification~~ | **High** | ~~Add Playwright smoke tests for core pipeline (paste – detect – export); gate on CI~~ | Medium | **Resolved 2026-08-04** |
