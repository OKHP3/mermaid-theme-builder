...
**Covers:** Mermaid 11.11.0 through 11.16.0  
...
| Feature                                         | Category    | Builder coverage           | Notes                                                                                                       |
| ----------------------------------------------- | ----------- | -------------------------- | ----------------------------------------------------------------------------------------------------------- |
| Cynefin framework (beta)                        | New diagram | ✅ Registry entry          | Detection and capability metadata added. No example is surfaced yet.                                        |
| Railroad diagrams (beta)                        | New diagram | ✅ Registry entry          | Detection and capability metadata added. No example is surfaced yet.                                        |
| Standalone swimlane diagrams (beta)             | New diagram | ✅ Registry entry          | Detection and capability metadata added. No example is surfaced yet.                                        |
| TreeView improvements                           | Renderer    | ✅ Existing registry entry | Existing TreeView detection remains compatible with the upgraded renderer.                                  |
| Architecture, ER, Gantt, and donut improvements | Renderer    | ✅ (passive)               | The builder consumes Mermaid rendering through the npm dependency. No export contract changes are required. |
| Security and parsing fixes                      | Security    | ✅ (passive)               | No builder action required.                                                                                 |
