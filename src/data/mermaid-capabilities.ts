...
export const DIAGRAM_CAPABILITIES: DiagramCapability[] = [
  ...
  },
  {
    ...
    supportsSubgraphStyle: false,
    notes:
      "Beta diagram type. Mermaid 11.15 added configurable nodeWidth, nodePadding, custom node colors, and outlined labels — themeVariables now apply more reliably to node fills and labels. Individual link flow colors are still internally cycled.",
    supportStatus: "partial",
    themeConfidence: "medium",
    notationCompliance: "mermaid-native",
    description:
  ...
  },
  {
    ...
    supportsSubgraphStyle: false,
    notes:
      "Official declaration is `packet` (v11.0.0+); `packet-beta` is accepted as a legacy fallback. Background and text colors apply. Packet field-specific colors are not controlled by themeVariables. v11.7.0 added bit-count shorthand syntax.",
    supportStatus: "partial",
    themeConfidence: "generic-only",
    notationCompliance: "mermaid-native",
    description:
