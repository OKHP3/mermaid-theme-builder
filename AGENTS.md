...
| `src/__tests__/` | 61 unit and component test files | Hand-authored; none are generated |
| `src/__tests__/__snapshots__/` | 3 snapshot files | Generated; safe to delete and regenerate |
| `src/components/` | 15 React components | All PascalCase .tsx |
...
| `src/lib/` | 21 pure logic modules | All kebab-case .ts |
...
| `docs/` | 29 top-level files plus `roadmap/` | Human-authored product, design, process, and research documentation |
| `e2e/` | 12 Playwright spec files | All hand-authored |
...
| `scripts/` | 6 maintenance scripts | Includes the technology-version audit and E2E wrapper |
| `.github/workflows/` | 8 workflows | CI, deployment, E2E, links, skill tests, token sync, and version audit |
| `.agents/skills/okhp3-mermaid-theme-builder/` | SKILL.md, tests, assets, references, scripts | Full headless skill package; tested via skill-tests.yml |
...
`node --test tests/*.test.mjs` from within `.agents/skills/okhp3-mermaid-theme-builder/`
